...
var editor = {
    ...
    dialogAddImg: function () {
        ...
        var button_array = ([{ "name": "Выбор изображения", "func": "baggeneral.openDialogSelectImage('url_new_img');" },
            { "name": "Добавить", "func": "editor.insertImg();" },
            { "name": "Отмена", "func": 'bag("#dialog_addimg").remove();' }]);
